...
> [!NOTE]
> 이 문서는 RenderDragon Shaders 웹페이지화가 진행되고 있음에 따라 더이상 유지보수되지 않습니다.
> 만약 링크가 망가졌거나 최신버전의 셰이더를 다운받고 싶으신 분들은 [영문 문서](README.md)를 참고하시길 바랍니다.
> (영문 문서라고 크게 다르지는 않습니다.)
...
https://discord.gg/yss
  ...
  - 1.9.7.6 Beta Fix (만약 검은 화면이나 불규칙한 빛번짐 효과를 겪고 있다면, 이것을 시도해보세요.)
...
<br/>
  ...
  - 1.0 beta 9.5
![](https://img.shields.io/badge/이_버전부터_호환됨-Android-black?style=flat-square&logo=android)
...
![](https://img.shields.io/badge/이_버전부터_호환됨-Switch-e60012?style=flat-square&logo=nintendoswitch)
